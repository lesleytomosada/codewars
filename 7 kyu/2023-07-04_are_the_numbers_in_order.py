...
# In this Kata, your function receives an array of integers as input. Your
# task is to determine whether the numbers are in ascending order. An array is
# said to be in ascending order if there are no two adjacent integers where
...
# in_asc_order([9,8,7,6,5,4,3,2,1]) # returns False because the numbers are in
# DESCENDING order
