...
# a single potential member. Information consists of an integer for person's
...
def open_or_senior(data):
    # input: list of pairs, first age, second handicap
    # return list of strings, with open or senior for each person
    # senior age needs to be 55+ and handicap 8+
