...
# C, Go, Nim, Pascal, COBOL, Erlang, [-1, -1, -1] for Perl,[] for Kotlin or
# "-1 -1 -1" for others.
...
def race(v1, v2, g):
    if v1 >= v2:
        return None
    velocity_diff = v2 - v1
    hours = g // velocity_diff
    mins = (g * 60 // velocity_diff) - hours * 60
    seconds = int((((g * 60 / velocity_diff) - hours * 60 - mins) * 60))
