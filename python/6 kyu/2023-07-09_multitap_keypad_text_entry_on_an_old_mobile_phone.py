...
#  the screen display for the current character cycles through P->Q->R->S->7).
#  A character is "locked in" once the user presses a different key or pauses
#  for a short period of time (thus, no extra button presses are required
#  beyond what is needed for each letter individually). The zero key handles
#  spaces, with one press of the key producing a space and two presses
#  producing a zero.
...
#  upper/lowercase characters (but you should allow your module to accept
