...
# 58, 60]. John is tired of driving and he says to Mary that he doesn't want
...
# [50,55,58],[50,55,60],[50,57,58],[50,57,60],[50,58,60],[55,57,58],[55,57,60],[55,58,60],[57,58,60].
...
# element). The function returns the "best" sum ie the biggest possible sum of
# k distances less than or equal to the given limit t, if that sum exists, or
# otherwise nil, null, None, Nothing, depending on the language. In that case
# with C, C++, D, Dart, Fortran, F#, Go, Julia, Kotlin, Nim, OCaml, Pascal,
